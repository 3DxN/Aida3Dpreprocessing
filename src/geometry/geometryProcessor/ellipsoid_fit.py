# From: https://github.com/marksemple/pyEllipsoid_Fit/blob/master/ellipsoid_fit.py
"""
A Python adaptation of Yury Petrov's ellipsoid_fit function for MATLAB. 
